 ...
 */
public class CSVNullableParser extends CSVParser{
     ...
     */
    public CSVNullableParser( final char delimiter, final boolean trimFields )
    {
...
//                        tokens.add( tokenBuf.toString() );
                        String v = tokenBuf.toString();
                        tokens.add( "".equals(v) ? null : v);
